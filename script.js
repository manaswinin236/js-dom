...
var domClass = document.getElementsByClassName("dom-methods");
for( var i = 0; i < domClass.length; i++ ){
  domClass[i].style.color = "red";
}
...
domClass = document.querySelectorAll(".dom-methods");
for( var i = 0; i < domClass.length; i++ ){
  domClass[i].style.fontSize = "20px";
}
...
let perviousText = newDiv.textContent = "Division";
...
newDiv.innerHTML = perviousText + " This is a division";
...
// Access the element with class "footer" using querySelector
